...
export declare type MarkerGlyphProps = CommonProps & LineProps & FillProps & {
...
export declare type MarkerHatchGlyphProps = MarkerGlyphProps & HatchProps;
...
export declare type MarkerGlyphUniforms = CommonUniforms & {
    u_size_hint: number;
};
...
export declare type MarkerGlyphAttributes = LineAttributes & FillAttributes & {
...
export declare type MarkerHatchGlyphAttributes = MarkerGlyphAttributes & HatchAttributes;
export {};
