...
1. ``read_peaklist`` converts your peak list into a ``.csv`` file and selects clusters of peaks.
...
3. ``fit_peaks`` fits clusters of peaks using the ``.csv`` peak list generated (or edited) by the ``read_peaklist (edit_fits)`` script(s).
