...
for ind, group in groups:
    ...
    plt.errorbar(group.vclist,group.amp,yerr=group.amp_err,fmt="o",markersize=10,label=group.assignment.iloc[0],c="#33a02c")
    ...
    for axis in ['top','bottom','left','right']:
        plot.axes.spines[axis].set_linewidth(2.)
    #plt.legend()
