...
read_peaklist.py peaks.a2 test.ft2 --a2 --show --struc_el=disk --outfmt=csv
...
fit_peaks.py peaks.csv test.ft2 fits.csv --x_radius=0.075 --y_radius=0.2 --max_cluster_size=10 #--plot=out --show --max_cluster_size=10
